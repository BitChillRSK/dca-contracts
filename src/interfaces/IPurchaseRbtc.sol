...
interface IPurchaseRbtc {
     ...
     *      purchase venue and never trusts an integrator return value. It is independent of any
     *      venue-side floor the route already applies: whichever is stricter wins, and a caller value can
