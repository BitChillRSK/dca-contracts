...
- Assigned: [R6-hot-path-cleanup.md](./R6-hot-path-cleanup.md) (PR 6, GitHub [#47](https://github.com/BitChillRSK/dca-contracts/pull/47)). Bundles R6 / R17. No product gates. Stacked on [#46](https://github.com/BitChillRSK/dca-contracts/pull/46).
- Next unassigned: `Start with R8` (PR 7, remove stuck-rBTC rescue). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
