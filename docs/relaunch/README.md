...
- Assigned: [R35-route-index-terminology.md](./R35-route-index-terminology.md) (PR 27). Rename DcaManager `lendingProtocolIndex` → `routeIndex` after #70. Stack on [#70](https://github.com/BitChillRSK/dca-contracts/pull/70).
...
- Next unassigned: `Start with R32` (PR 28). Stack on this PR once it is open. No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / remaining optionals.
