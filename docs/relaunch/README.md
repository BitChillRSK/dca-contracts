...
- Assigned: [R6-hot-path-cleanup.md](./R6-hot-path-cleanup.md) (PR 6). Bundles R6 / R17. No product gates. Stacked on [#46](https://github.com/BitChillRSK/dca-contracts/pull/46).
