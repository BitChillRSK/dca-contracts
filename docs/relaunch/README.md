...
- Assigned: [R32-internal-cleanup.md](./R32-internal-cleanup.md) (PR 27). Behavior-preserving DcaManager/lending cleanup after the public surfaces settle. No product gate. Stack on R34.
- Next unassigned: `Start with R32` (PR 27). Stack on [#70](https://github.com/BitChillRSK/dca-contracts/pull/70). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / remaining optionals.
