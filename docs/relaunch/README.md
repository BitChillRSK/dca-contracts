...
- Assigned: [R8-remove-stuck-rbtc-rescue.md](./R8-remove-stuck-rbtc-rescue.md) (PR 7). No product gates. Stacked on [#47](https://github.com/BitChillRSK/dca-contracts/pull/47).
