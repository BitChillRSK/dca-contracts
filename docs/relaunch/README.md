...
- Next unassigned: `Start with R15` (PR 10, withdraw-all sentinel and share dust). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
