...
- Next unassigned: `Start with R22 (deploy/CI)` (PR 20, [R22-deploy-ci.md](./R22-deploy-ci.md)). Then R9 (PR 21). Handler-replacement in `OperationsAdmin` stays unassigned. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
