...
- Assigned: [R33-uniswap-slippage-validation.md](./R33-uniswap-slippage-validation.md) (PR 23). One constructor/setter slippage invariant. No product gate. Stack on [#66](https://github.com/BitChillRSK/dca-contracts/pull/66).
...
- Next unassigned: `Start with R33` (PR 23). Stack on [#66](https://github.com/BitChillRSK/dca-contracts/pull/66); there is no product gate. PR 2 (decision record) stays available when the human wants to record R18 / R19 / remaining optionals.
