...
- Next unassigned: `Start with R34` (PR 26). Stack on [#69](https://github.com/BitChillRSK/dca-contracts/pull/69). Ask the schedule-mutation surface and frontend/backend consumer cutover. PR 2 (decision record) stays available when the human wants to record R18 / R19 / remaining optionals.
