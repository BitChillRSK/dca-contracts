...
- Assigned: [R27-tropykus-lending-guards.md](./R27-tropykus-lending-guards.md) (PR 18). Align Tropykus deposit/batch zero-cash guards with Sovryn/LayerBank. Reordered ahead of R22 deploy/CI. Stack on [#61](https://github.com/BitChillRSK/dca-contracts/pull/61).
