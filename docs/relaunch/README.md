...
- Assigned: [R32-internal-cleanup.md](./R32-internal-cleanup.md) (PR 28). Behavior-preserving DcaManager/lending cleanup after the public surfaces settle. No product gate. Stack on R35.
- Next unassigned: `Start with R32` (PR 28). Stack on [#71](https://github.com/BitChillRSK/dca-contracts/pull/71). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / remaining optionals.
