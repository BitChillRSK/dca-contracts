...
- Planning: GitHub [#60](https://github.com/BitChillRSK/dca-contracts/pull/60). Specs only: R26 (PR 17), R27/R28 (later reordered ahead of R22 deploy/CI), R28 was optional late until promoted. Stacked on [#59](https://github.com/BitChillRSK/dca-contracts/pull/59).
- Assigned: [R26-share-terminology.md](./R26-share-terminology.md) (PR 17, GitHub [#61](https://github.com/BitChillRSK/dca-contracts/pull/61)). Rename-only: “lending token” → `shares`. Stacked on [#60](https://github.com/BitChillRSK/dca-contracts/pull/60).
...
- Next unassigned: `Start with R28` (PR 19, [R28-lending-erc20-handler.md](./R28-lending-erc20-handler.md)) — extract `LendingErc20Handler` (Idle out). Stack on [#62](https://github.com/BitChillRSK/dca-contracts/pull/62). Then `Start with R22 (deploy/CI)` (PR 20, [R22-deploy-ci.md](./R22-deploy-ci.md)). Then R9 (PR 21). Handler-replacement in `OperationsAdmin` stays unassigned. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
