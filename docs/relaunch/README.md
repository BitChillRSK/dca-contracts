...
- Assigned: [R22-repo-layout.md](./R22-repo-layout.md) (PR 11). Folders only; no product gates. Stacked on [#51](https://github.com/BitChillRSK/dca-contracts/pull/51).
- Next unassigned: `Start with R22 (idle)` (PR 12, idle handler). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
