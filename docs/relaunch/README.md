...
- Next unassigned: `Start with R1` (PR 8, SIP-0094 / balance-delta cash). No product gates. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
