...
- Next unassigned: `Start with R22 (deploy/CI)` (PR 21, [R22-deploy-ci.md](./R22-deploy-ci.md)). Stack on [#64](https://github.com/BitChillRSK/dca-contracts/pull/64). Handler-replacement in `OperationsAdmin` stays unassigned. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
