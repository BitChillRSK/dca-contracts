...
- Next unassigned: `Start with R29` (PR 20, [R29-hardcode-exchange-rate-scale.md](./R29-hardcode-exchange-rate-scale.md)). Stack on [#63](https://github.com/BitChillRSK/dca-contracts/pull/63). Then `Start with R22 (deploy/CI)` (PR 21). Handler-replacement in `OperationsAdmin` stays unassigned. PR 2 (decision record) stays available when the human wants to record R18 / R19 / optionals.
