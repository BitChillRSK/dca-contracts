...
- Fork tests: run `make fork-sovryn` and `make fork-tropykus` before any push that changes executable code (**Scale the gate to the change** in `AGENTS.md`). Use this line only to say whether this item adds fork-specific assertions.
