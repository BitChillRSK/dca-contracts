...
`DcaManager.setOperationsAdmin` is recorded in the spec as a known governance surface but is explicitly **out of scope** here. See [`R13-operations-admin-lifecycle.md`](./R13-operations-admin-lifecycle.md).
